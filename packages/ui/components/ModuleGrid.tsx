...
const moduleGridVariants = cva('module-grid', {
  variants: {
    variant: {
      ...
      section: 'bg-black shadow-md border-[2px] rounded-3xl flex flex-col',
    },
    size: {
...
function ModuleGridInfoContent({
  ...
  return (
    <ModuleGridContent
      className={cn(
        'text-web3sheet-text flex h-full w-1/2 flex-col items-center justify-center gap-6 self-center text-center text-xl',
        className,
      )}
    >
      {children}
